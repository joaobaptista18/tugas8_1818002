...
const BlogDetail = ({route}) => {
  ...
  const getBlogById = async () => {
    try {
      const response = await axios.get(
        `https://6564445cceac41c0761dbfbe.mockapi.io/labuanbajoapp/blog/${blogId}`,
      );
  ...
  const handleDelete = async () => {
   await axios.delete(`https://6564445cceac41c0761dbfbe.mockapi.io/labuanbajoapp/blog/${blogId}`)
      .then(() => {
        closeActionSheet()
